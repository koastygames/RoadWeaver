...
object StructureRegistryFabric {
    ...
    private fun registerStructureTypes() {
        // 注册路边结构类型
        val roadsideType: StructureType<RoadsideStructure> = StructureType { RoadsideStructure.CODEC }
        Registry.register(
        ...
        // 注册初始小屋结构类型
        val spawnCabinType: StructureType<SpawnCabinStructure> = StructureType { SpawnCabinStructure.CODEC }
        Registry.register(
            BuiltInRegistries.STRUCTURE_TYPE,
