 ...
 * Fabric 平台的配置屏幕工厂实现
 */
object ConfigScreenFactoryImpl {
    /**
     * 创建配置屏幕 (Fabric实现)
     *
     * 注意：该方法会被 common 的 @ExpectPlatform (ConfigScreenFactory#createConfigScreen) 替换调用，
     * 因此必须是 JVM 静态方法。
     */
    @JvmStatic
    fun createConfigScreen(parent: Screen): Screen {
        ...
        val conf: ModConfig = ConfigService.get()
        val defaultConf = ModConfig() // 用于 Cloth Config “重置”按钮：提供每个选项的默认值
        builder.setSavingRunnable(ConfigService::save)

        val filters: ConfigCategory = builder.getOrCreateCategory(
        ...
        filters.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.enable_prediction"),
        ...
        filters.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.radius_chunks"),
        ...
        filters.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.biome_prefilter"),
                conf.biomePrefilter()
            )
        ...
        filters.addEntry(OpenStructureSelectionEntry())

        val planning: ConfigCategory = builder.getOrCreateCategory(
            Component.translatable("config.roadweaver.category.road_planning")
        )

        planning.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.initial_plan_radius_chunks"),
        ...
        planning.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.dynamic_plan_enabled"),
        ...
        planning.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.dynamic_plan_radius_chunks"),
        ...
        planning.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.dynamic_plan_stride_chunks"),
            ...
            eb.startEnumSelector(
                ...
                .setEnumNameProvider { v ->
                    Component.translatable(
                        "config.roadweaver.planning_algorithm.option." + v.name.lowercase(Locale.ROOT)
                    )
                }
        ...
        val roadGen: ConfigCategory = builder.getOrCreateCategory(
            Component.translatable("config.roadweaver.category.road_generation")
        )

        roadGen.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.allow_artificial"),
        ...
        roadGen.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.allow_natural"),
                conf.allowNatural()
            )
        ...
        roadGen.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.place_waypoints"),
                conf.placeWaypoints()
            )
        ...
        roadGen.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.spawn_cabin_enabled"),
        ...
        roadGen.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.road_width"),
                conf.roadWidth()
            )
        ...
        roadGen.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.village_road_offset"),
        ...
        roadGen.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.other_structure_road_offset"),
        ...
        roadGen.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.road_signs_enabled"),
        ...
        roadGen.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.lamp_interval"),
                conf.lampInterval()
            )
        ...
        roadGen.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.road_clear_height"),
        ...
        roadGen.addEntry(OpenPresetEditorEntry())

        val genSurface: ConfigCategory = builder.getOrCreateCategory(
            Component.translatable("config.roadweaver.category.gen_surface")
        )

        genSurface.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.averaging_radius"),
        ...
        genSurface.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.max_slope_step_per_two_segments"),
                conf.maxSlopeStepPerTwoSegments()
            )
                .setDefaultValue(defaultConf.maxSlopeStepPerTwoSegments())
                .setTooltip(
                    Component.translatable("config.roadweaver.max_slope_step_per_two_segments.tooltip")
                )
                .setMin(0)
                .setMax(8)
        ...
        genSurface.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.slope_limit_enabled"),
        ...
        genSurface.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.causeway_max_depth"),
        ...
        // 桥梁设置
        val bridge: ConfigCategory = builder.getOrCreateCategory(
            Component.translatable("config.roadweaver.category.bridge")
        )

        bridge.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.bridge_enabled"),
                conf.bridgeEnabled()
            )
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.bridge_deck_clearance"),
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.bridge_max_length_blocks"),
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.buoy_interval_blocks"),
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.bridge_pier_interval"),
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.bridge_pier_width"),
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.bridge_pier_max_height"),
        ...
        bridge.addEntry(
            eb.startBooleanToggle(
                Component.translatable("config.roadweaver.bridge_keep_lamps"),
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.bridge_ramp_segments"),
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.bridge_min_water_depth"),
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.bridge_min_length"),
        ...
        bridge.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.bridge_merge_gap"),
                conf.bridgeMergeGap()
            )
        ...
        // 路边结构设置
        val roadsideStructures: ConfigCategory = builder.getOrCreateCategory(
        ...
        val genPerformance: ConfigCategory = builder.getOrCreateCategory(
            Component.translatable("config.roadweaver.category.gen_performance")
        )

        genPerformance.addEntry(
            eb.startIntField(
                Component.translatable("text.autoconfig.roadweaver.option.computeThreads"),
                conf.computeThreads()
            )
        ...
        genPerformance.addEntry(
            eb.startIntField(
                Component.translatable("text.autoconfig.roadweaver.option.generationThreads"),
        ...
        genPerformance.addEntry(
            eb.startIntField(
                Component.translatable("text.autoconfig.roadweaver.option.initialGenerationThreads"),
                conf.initialGenerationThreads()
            )
                .setDefaultValue(defaultConf.initialGenerationThreads())
                .setTooltip(
                    Component.translatable("text.autoconfig.roadweaver.option.initialGenerationThreads.@Tooltip")
                )
                .setMin(1)
                .setMax(64)
        ...
        genPerformance.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.max_concurrent_generations"),
        ...
        genPerformance.addEntry(
            eb.startIntSlider(
                Component.translatable("config.roadweaver.thread_duty_cycle"),
                conf.threadDutyCycle(),
                1,
                100
            )
        ...
        val pathfindingCosts: ConfigCategory = builder.getOrCreateCategory(
            Component.translatable("config.roadweaver.category.pathfinding_costs")
        )

        val pathfindingAlgo: ModConfig.PathfindingAlgorithm = conf.pathfindingAlgorithm()
        ...
        pathfindingCosts.addEntry(
            eb.startEnumSelector(
                ...
                ModConfig.PathfindingAlgorithm::class.java,
                pathfindingAlgo
            )
                ...
                .setEnumNameProvider { v ->
                    Component.translatable(
                        "config.roadweaver.pathfinding_algorithm.option." + v.name.lowercase(Locale.ROOT)
                    )
                }
        ...
        pathfindingCosts.addEntry(
            eb.startBooleanToggle(
                ...
                .setTooltip(
                    Component.translatable("config.roadweaver.hierarchical_pathfinding_enabled.tooltip")
                )
        ...
        pathfindingCosts.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.a_star_step"),
                conf.aStarStep()
            )
        ...
        pathfindingCosts.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.a_star_max_steps"),
                conf.aStarMaxSteps()
            )
        ...
        pathfindingCosts.addEntry(
            eb.startDoubleField(
                Component.translatable("config.roadweaver.ortho_step_cost"),
                conf.orthoStepCost()
            )
        ...
        pathfindingCosts.addEntry(
            eb.startDoubleField(
                Component.translatable("config.roadweaver.diag_step_cost"),
                conf.diagStepCost()
            )
        ...
        pathfindingCosts.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.elevation_weight"),
        ...
        pathfindingCosts.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.biome_weight"),
                conf.biomeWeight()
            )
        ...
        pathfindingCosts.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.stability_weight"),
        ...
        pathfindingCosts.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.water_depth_weight"),
        ...
        pathfindingCosts.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.near_water_cost"),
                conf.nearWaterCost()
            )
        ...
        pathfindingCosts.addEntry(
            eb.startIntField(
                Component.translatable("config.roadweaver.water_proximity_cost"),
        ...
        pathfindingCosts.addEntry(
            eb.startDoubleField(
                Component.translatable("config.roadweaver.heuristic_weight"),
        ...
        pathfindingCosts.addEntry(
            eb.startDoubleField(
                Component.translatable("config.roadweaver.deviation_weight"),
