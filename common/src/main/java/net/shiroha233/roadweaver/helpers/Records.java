...
public final class Records {
    ...
    public record RoadData(int width, int roadType, List<BlockState> materials, List<BlockState> slabMaterials, List<RoadSegmentPlacement> roadSegmentList, List<RoadSpan> spans, List<Integer> targetY) {
