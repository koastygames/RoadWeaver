...
public final class MSTPlanner {
    ...
    public static List<Records.StructureConnection> planMST(List<BlockPos> points, int maxEdgeLenBlocks) {
        ...
        ArrayList<Records.StructureConnection> result = new ArrayList<>();
        ...
        for (Edge e : edges) {
            ...
            result.add(new Records.StructureConnection(pa, pb));
        }
