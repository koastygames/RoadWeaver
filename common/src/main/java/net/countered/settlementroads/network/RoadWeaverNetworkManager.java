...
public class RoadWeaverNetworkManager {
    ...
    // 数据包ID
    public static final ResourceLocation REQUEST_DEBUG_DATA = ResourceLocation.fromNamespaceAndPath("roadweaver", "request_debug_data");
    public static final ResourceLocation SEND_DEBUG_DATA = ResourceLocation.fromNamespaceAndPath("roadweaver", "send_debug_data");
