 ...
 * - 在右下角绘制当前提示文本
 */
object LoadingTipsRenderer {
    /** 每条提示停留时间（毫秒） */
    private const val INTERVAL_MILLIS: Long = 3000L

    /** 提示文本列表，使用可本地化的翻译键 */
    private val TIPS: List<Component> = listOf(
    ...
    /** 上次切换提示的时间戳（毫秒） */
    private var lastSwitchTimeMillis: Long = 0L
    ...
    fun render(graphics: GuiGraphics) {
        ...
        val marginX = 6
        val marginY = 6
        val x = sw - font.width(tip) - marginX
        val y = sh - font.lineHeight - marginY
