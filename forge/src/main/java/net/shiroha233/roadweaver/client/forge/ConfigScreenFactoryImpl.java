...
public class ConfigScreenFactoryImpl {
        ...
        public static Screen createConfigScreen(Screen parent) {
                ...
                planning.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setInitialPlanRadiusChunks(v);
                                })
                                .build());
                planning.addEntry(eb
                ...
                planning.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setDynamicPlanRadiusChunks(v);
                                })
                                .build());
                planning.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setDynamicPlanStrideChunks(v);
                                })
                                .build());
                ...
                highway.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setHighwayAutoPlanEnabled(v);
                                })
                                .build());
                highway.addEntry(eb
                ...
                highway.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setHighwayDynamicPlanEnabled(v);
                                })
                                .build());
                highway.addEntry(eb
                ...
                highway.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setHighwaySlopeLimitEnabled(v);
                                })
                                .build());
                highway.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setHighwaySlopeRunBlocks(v);
                                })
                                .build());
                highway.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setHighwaySlopeRiseBlocks(v);
                                })
                                .build());
                highway.addEntry(eb
                ...
                highway.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setHighwayAStarMaxSteps(v);
                                })
                                .build());
                highway.addEntry(eb
                                ...
                                .setMin(0).setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setHighwayFloatingWeight(v);
                                })
                                .build());
                highway.addEntry(eb
                                .startDoubleField(
                                ...
                                .setMin(0).setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setHighwayPenetrationWeight(v);
                                })
                                .build());
                ...
                longDrive.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setLongDriveSegmentLength(v);
                                })
                                .build());
                longDrive.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setLongDriveLeadDistance(v);
                                })
                                .build());
                longDrive.addEntry(eb
                                ...
                                .setSaveConsumer(v -> {
                                        if (v != null)
                                                conf.setLongDriveDirectionBias(v);
                                })
                                .build());
