...
/**
 * NeoForge 平台的配置屏幕工厂实现
 */
object ConfigScreenFactoryImpl {
    /**
     * 创建配置屏幕 (NeoForge 实现)
     *
     * 注意：该方法会被 common 的 @ExpectPlatform (ConfigScreenFactory#createConfigScreen) 反射/字节码替换调用，
     * 因此必须是 JVM 静态方法。
     */
    @JvmStatic
    fun createConfigScreen(parent: Screen): Screen {
        ...
        // 路网规划分类
        val planning = builder.getOrCreateCategory(
        ...
        val roadGen = builder.getOrCreateCategory(
        ...
        val genSurface = builder.getOrCreateCategory(
        ...
        // 桥梁设置
        val bridge = builder.getOrCreateCategory(
        ...
        // 路边结构设置
        val roadsideStructures = builder.getOrCreateCategory(
        ...
        val genPerformance = builder.getOrCreateCategory(
        ...
        val pathfindingCosts = builder.getOrCreateCategory(
